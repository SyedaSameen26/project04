import json #built in module used to save and store data
import os #system operation and file handling
data_file="library.txt" #making variable to store data
#making functions
def load_library():
...
def add_book(library):
    ...
    read =input("have u read this book:(yes/no) ").lower()=="yes"
    new_book={
       "title":title,
       "author":author,
       "year":year,
...
def main():
    ...
    while True:
         print("wellcome to library manager")
         print("menu")
         print("1. Add a book")
